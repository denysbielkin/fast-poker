...
const Game = () => {
    ...
    const findTheWinner = (player_1: PlayerType, player_2: PlayerType) => {
    ...
    const [winner, setWinner] = useState<WinnerType>(findTheWinner(player_1, player_2));

    const setNewWinner: Function = (player_1: PlayerType, player_2: PlayerType) => setWinner(findTheWinner(player_1, player_2));
